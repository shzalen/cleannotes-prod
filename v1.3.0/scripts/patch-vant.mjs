 ...
 *
 * Vant 4's package.json has `"sideEffects": ["es/**/style/*","lib/**/style/*","*.css"]`
 * which marks all JS modules as side-effect-free. This causes Rollup to tree-shake
 * components that are only referenced indirectly via `app.use(Vant)` / `Object.values()`.
 *
